            ...
            !rows.length
                ...
                <table className="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th style={{width:'20%'}}>
                            <a onClick={this.props.sortChanged.bind(null, 'name', this.props.orderType)}>
                                Name
                                <i className={this.props.sortClass('name')}></i>
                            </a>
                        </th>
                        <th style={{width:'40%'}}>
                        ...
                        <th style={{width:'9%'}}>
                            <a onClick={this.props.sortChanged.bind(null, 'category', this.props.orderType)}>
                                Category
                                <i className={this.props.sortClass('category')}></i>
                            </a>
                        </th>
                        <th>Action</th>
                    </tr>
        ...
        return (
            <div className="">
...

                {
                    ...
                    ?
                        <div>
                            <a href="#create" className="btn btn-primary margin-bottom-1em float-right" >
                                <span className='glyphicon glyphicon-plus'></span>&nbsp;
                                Create Product
                            </a>

                            <button className="btn btn-danger margin-bottom-1em float-right" onClick={this.props.deleteSelected} style={{marginRight:'10px'}}>
...
var PaginationComponent = React.createClass({
    render: function() {
        ...
        for (let i=1; i <= pagesAmount; i++) {
            pageIndicators.push(
                <li className={i == this.props.currentPage ? "page-item active":"page-item"} key={i}>
                    <a className="page-link" href={'#page=' + i + appendUrl} onClick={this.props.onPageChanged.bind(null, i)}>{i}</a>
                </li>
            )
        }
            ...
            !this.props.productsAmount ? null :
                <nav className='overflow-hidden' style={{marginBottom:'20px'}}>
                        ...
                        <ul className='pagination float-left'>
                            {
                                this.props.currentPage == 1 ? null :
                                    <li className="page-item">
                                        <a className="page-link" href={'#page=1' + appendUrl} onClick={this.props.onPageChanged.bind(null,1)}>
...

                            {
                                this.props.currentPage == 1 ? null :
                                    <li className="page-item">
                                        <a className="page-link" href={'#page='+ (this.props.currentPage - 1) + appendUrl} onClick={this.props.onPageChanged.bind(null,1)}>
...

                            {
                                this.props.currentPage == pagesAmount ? null :
                                    <li className="page-item">
                                        <a className="page-link" href={'#page='+ (parseInt(this.props.currentPage) + 1) + appendUrl} onClick={this.props.onPageChanged.bind(null, pagesAmount)}>
...

                            {
                                this.props.currentPage == pagesAmount ? null :
                                    <li className="page-item">
                                        <a className="page-link" href={'#page=' + pagesAmount + appendUrl} onClick={this.props.onPageChanged.bind(null, pagesAmount)}>
                    ...
                    <form method="get" action="#">
                        <div className="input-group col-md-2 float-right">
                        ...
                        <div className="input-group col-md-3 float-right" style={{marginRight:'10px'}}>
        ...
        if(this.state.selectedRows.length > 0) {
            ...
            if (r == true) {
                $.post({
                        ...
                        data: {del_ids: this.state.selectedRows},
                        headers: authHeader()
                    },
                    function (res) {
                        console.log(res);
